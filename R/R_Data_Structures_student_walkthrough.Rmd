...
You can also use the optional levels parameter to specify the order in which the levels should be displayed (When sorted).
...
4.  Print the second column of both matrices.
    ...
    ```{r}
    #print 5 from first matrix[]
    vector_array[2,2,1]
    ```

    ```{r}
    # print 5 from second matrix
    vector_array[2,2,2]
    ```
