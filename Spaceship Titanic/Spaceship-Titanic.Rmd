...
```{r}
ggplot(trainingData, aes(x=Transported, y=TotalSpent)) + geom_violin(aes(fill=Transported), trim=FALSE) + labs(x="Transported", y="Spa")
```

```{The group that was transported spent much less money overall.}
Most of the passengers who were transported spent no money.
```
